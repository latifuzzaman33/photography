<?php
/**
 * Plugin Name: toolkit popular post
 * Description: This is popular post new features
 * Plugin URI:  https://latifmatubber21.com/popular-post
 * Version:     1.0.0
 * Author:      latif matubber
 * Author URI:  latifmatubber21.com/
 * Text Domain: popularPost
 */

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}
class popular_post_widget_cls extends WP_Widget{

    public function __construct() {
        parent::__construct('popular_post_widget',__('Popular Post','popularPost'),array(
            'description'=>__('Add popular post here','popularPost'),
        ));
    }
...
function popular_post_widget_funct(){

    register_widget('popular_post_widget_cls');

}
add_action('widgets_init','popular_post_widget_funct');